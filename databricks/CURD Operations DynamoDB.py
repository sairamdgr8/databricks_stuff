...
##2.Create record in a DynamoDB table
...
##3.Get a record in from DynamoDB table
...
##4. Update a record in DynamoDB table
...
##5. Increment an Atomic Counter in DynamoDB table
...
##6. Delete an Item in DynamoDB table
...
if __name__ == '__main__':
    ...
    ##5. Increment an Atomic Counter in DynamoDB
